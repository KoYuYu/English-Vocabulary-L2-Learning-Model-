...
<div id="main_contant"> 
    <div class="center_frame">
	 ...
	 <p align="center"><img src="images/parser_logo.png" width="170px"; height="60px">
	 <br>
	 <br>
<form action="parser2.php" method="post" align="center">
  <p>請貼上文章: <br>
  <textarea name="text" style="width:400px;height:120px;"></textarea>
