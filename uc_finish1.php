...
$sql="INSERT INTO `classword1_$id` (`english` ,`chinese` ,`classname`) VALUES ((SELECT `english` FROM `pydict` WHERE `english` = ".$eng[$i]."),(SELECT `chinese` FROM `pydict` WHERE `english` = ".$eng[$i]."),$class)";
//echo $sql;
echo '<br>';
