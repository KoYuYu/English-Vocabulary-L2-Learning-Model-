...
$sql="INSERT INTO `classword_$id` (`english` ,`chinese` ,`classname`) VALUES ((SELECT `english` FROM `pydict` WHERE `english` = ".$eng[$i]."),(SELECT `chinese` FROM `pydict` WHERE `english` = ".$eng[$i]."),$class)";
//echo $sql;
echo '<br>';
...
?>
<form name="search" method="post" action="classRoom.php">
<input type="submit" name="button" value="回到classroom" /></p>
</form>
