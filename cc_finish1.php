...
$sql4 = "SELECT `class_id` FROM `class` WHERE `classname` = '$classname'";
$result4 = $conn -> query($sql4);
$row1 = $result4 -> fetch_array();
$class = $row1[0];
$sql3 = "SELECT  `classroom` FROM `member1` WHERE `email`='$id'"; 
...
//echo $newclass;
$sql4 = "UPDATE `member1` SET `classroom`='$newclass' WHERE `email`='$id'"; 
$result4 = $conn -> query($sql4);
...
<a href="classRoom1.php">back to classRoom</a>  <br> 
