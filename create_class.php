...
<!--slider start here--> 
<div id="main_contant"> 
	  	  	<td><a href="classRoom1.php"><img src="images/back_icon.png" title="回到課程總覽" border="0" width="70px" height="50px" ></a><br></td>
...
<h4><p align="center">建立新課程</p></h4>
	 <br>
	 <br>
    <form name="search" method="post" action="cc_finish1.php">
