...
<p align="center"><img src="images/tested_word.png" width="170px"; height="50px">
<br><br>
...
<p align="center">
<?php
$sql = "select count(`english`) from `quiz_600_record` where member='$id';";
$result = $conn -> query($sql) ;
$row=$result -> fetch_row();
 ...
 $page->setViewList("toefllist.php?", 'toefllist');  //設定導覽列資料,參數1為連結的頁面,參數2為連結的target(本參數可不設定)
 $showdata['viewlist'] = $page->viewlist; 
echo '<br>' ;
$sql = "select * from `quiz_600_record` where member='$id' limit {$page->started_record}, {$page->records_per_page}";
$result = $conn -> query($sql) ;
